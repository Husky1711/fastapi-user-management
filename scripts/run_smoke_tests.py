#!/usr/bin/env python3
"""Run smoke tests with optional pytest plugins disabled (CI stability)."""
...
def main() -> int:
    ...
    args = [
        ...
        "--capture=no",
        "--maxfail=5",
        "--junitxml=smoke-junit.xml",
        # Avoid optional plugins that can interfere with API smoke tests.
        "-p",
        "no:locust",
        "-p",
        "no:faker",
