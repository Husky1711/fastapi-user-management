#!/usr/bin/env python3
"""Run smoke tests directly (no pytest) for reliable CI execution."""
...
def _build_cases(cross_org_ids: dict[str, int]) -> list[tuple[str, object, dict]]:
    from tests.smoke import test_auth_smoke, test_idor_smoke, test_rbac_smoke

    cases: list[tuple[str, object, dict]] = [
        ("test_auth_smoke::test_login_refresh_logout", test_auth_smoke.test_login_refresh_logout, {}),
        ("test_auth_smoke::test_alembic_head_matches_schema", test_auth_smoke.test_alembic_head_matches_schema, {}),
        (
            "test_idor_smoke::test_cannot_read_user_in_other_org[testorgadmin]",
            test_idor_smoke.test_cannot_read_user_in_other_org,
            {"username": "testorgadmin", "password": "orgadmin123", "cross_org_ids": cross_org_ids},
        ),
        (
            "test_idor_smoke::test_cannot_read_user_in_other_org[testadmin]",
            test_idor_smoke.test_cannot_read_user_in_other_org,
            {"username": "testadmin", "password": "admin123", "cross_org_ids": cross_org_ids},
        ),
        (
            "test_idor_smoke::test_cannot_access_other_org_compliance_resources[orgadmin-get-group]",
        ...
        (
            "test_idor_smoke::test_cannot_access_other_org_compliance_resources[admin-patch-group]",
            test_idor_smoke.test_cannot_access_other_org_compliance_resources,
            {
                "username": "testadmin",
                "password": "admin123",
        ...
        (
            "test_idor_smoke::test_cannot_access_other_org_compliance_resources[orgadmin-get-api-key]",
            test_idor_smoke.test_cannot_access_other_org_compliance_resources,
            {
                "username": "testorgadmin",
                "password": "orgadmin123",
        ...
        (
            "test_idor_smoke::test_cannot_access_other_org_compliance_resources[admin-delete-api-key]",
            test_idor_smoke.test_cannot_access_other_org_compliance_resources,
            {
                "username": "testadmin",
                "password": "admin123",
        ...
        (
            "test_rbac_smoke::test_dashboard_role_matrix[testadmin-admin-overview]",
        ...
        (
            "test_rbac_smoke::test_dashboard_role_matrix[testorgadmin-org-overview]",
            test_rbac_smoke.test_dashboard_role_matrix,
            {
                "username": "testorgadmin",
                "password": "orgadmin123",
        ...
        (
            "test_rbac_smoke::test_dashboard_role_matrix[test_super_admin-super-overview]",
            test_rbac_smoke.test_dashboard_role_matrix,
            {
        ...
        (
            "test_rbac_smoke::test_dashboard_role_matrix[testuser-user-overview]",
            test_rbac_smoke.test_dashboard_role_matrix,
            {
                "username": "testuser",
                "password": "user123",
        ...
        (
            "test_rbac_smoke::test_dashboard_role_matrix[testorgadmin-denied-admin]",
            test_rbac_smoke.test_dashboard_role_matrix,
            {
                "username": "testorgadmin",
                "password": "orgadmin123",
        ...
        (
            "test_rbac_smoke::test_dashboard_role_matrix[testuser-denied-admin]",
            test_rbac_smoke.test_dashboard_role_matrix,
            {
                "username": "testuser",
                "password": "user123",
        ...
        (
            "test_rbac_smoke::test_dashboard_role_matrix[testadmin-denied-super]",
            test_rbac_smoke.test_dashboard_role_matrix,
            {
                "username": "testadmin",
                "password": "admin123",
        ...
        (
            "test_rbac_smoke::test_user_cannot_create_users",
            test_rbac_smoke.test_user_cannot_create_users,
            {},
        ),
    ]
...
def main() -> int:
    ...
    cases = _build_cases(cross_org_ids)
